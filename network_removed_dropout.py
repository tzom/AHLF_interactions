...
import sys,os
#sys.path.append('../TCN/')
from TCN_removed_relu import TCN
from path_explain.utils import softplus_activation
beta = 1000
activation = softplus_activation(beta=beta)
...
class network(tf.keras.Model):
    def __init__(self, num_channels, kernel_size, padding, dropout):
        ...
        self.ac0 = tf.keras.layers.Activation(activation)
        ...
        self.ac1 = tf.keras.layers.Activation(softplus_activation(beta=beta))
        ...
        self.ac2= tf.keras.layers.Activation(softplus_activation(beta=beta))
        ...
        self.ac3= tf.keras.layers.Activation(softplus_activation(beta=beta))
